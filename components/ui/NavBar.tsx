      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between py-4">
          ...
          <div className="hidden sm:flex sm:items-center">
            {links.map(link => <Link key={link.url} href={link.url}><a className={classnames.all + (isCurrent(current, link) ? classnames.current : classnames.other)}>{link.label}</a></Link>)}
          </div>
          <div className="hidden sm:flex sm:items-center">
            <a
              href="#"
